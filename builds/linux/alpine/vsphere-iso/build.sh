...
$REPO_ROOT_PATH/packer build -force \
-var-file="$REPO_ROOT_PATH/variables/common.pkrvars.hcl" \
-var-file="$REPO_ROOT_PATH/variables/vsphere.pkrvars.hcl" \
-var-file="$REPO_ROOT_PATH/builds/linux/alpine/vsphere-iso/linux-alpine.pkrvars.hcl" \
$REPO_ROOT_PATH/builds/linux/alpine/vsphere-iso